...
public class ModItems {
    ...
    public static final Item COAL_LOOT_BUNDLE = registerItem("coal_loot_bundle",
            new LootBundleItem(CoalLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item COPPER_LOOT_BUNDLE = registerItem("copper_loot_bundle",
            new LootBundleItem(CopperLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item IRON_LOOT_BUNDLE = registerItem("iron_loot_bundle",
            new LootBundleItem(IronLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item LAPIS_LOOT_BUNDLE = registerItem("lapis_loot_bundle",
            new LootBundleItem(LapisLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item GOLD_LOOT_BUNDLE = registerItem("gold_loot_bundle",
            new LootBundleItem(GoldLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));
    ...
    public static final Item REDSTONE_LOOT_BUNDLE = registerItem("redstone_loot_bundle",
            new LootBundleItem(RedstoneLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item DIAMOND_LOOT_BUNDLE = registerItem("diamond_loot_bundle",
            new LootBundleItem(DiamondLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item EMERALD_LOOT_BUNDLE = registerItem("emerald_loot_bundle",
            new LootBundleItem(EmeraldLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item ANCIENT_DEBRIS_LOOT_BUNDLE = registerItem("ancient_debris_loot_bundle",
            new LootBundleItem(AncientDebrisLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item QUARTZ_LOOT_BUNDLE = registerItem("quartz_loot_bundle",
            new LootBundleItem(QuartzLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));
    ...
    public static final Item CHICKEN_LOOT_BUNDLE = registerItem("chicken_loot_bundle",
            new LootBundleItem(ChickenLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item COW_LOOT_BUNDLE = registerItem("cow_loot_bundle",
            new LootBundleItem(CowLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item PIG_LOOT_BUNDLE = registerItem("pig_loot_bundle",
            new LootBundleItem(PigLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item SHEEP_LOOT_BUNDLE = registerItem("sheep_loot_bundle",
            new LootBundleItem(SheepLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));
    ...
    public static final Item CAVE_SPIDER_LOOT_BUNDLE = registerItem("cave_spider_loot_bundle",
            new LootBundleItem(CaveSpiderLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item DROWNED_LOOT_BUNDLE = registerItem("drowned_loot_bundle",
            new LootBundleItem(DrownedLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));
    ...
    public static final Item ZOMBIE_LOOT_BUNDLE = registerItem("zombie_loot_bundle",
            new LootBundleItem(ZombieLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));

    public static final Item SKELETON_LOOT_BUNDLE = registerItem("skeleton_loot_bundle",
            new LootBundleItem(SkeletonLootBundleContent.getItems(),1,new Item.Settings().maxCount(16)));
